...
public:
    ...
    inline ProfilerController* getProfilerController() const;
...
protected:
    ...
    virtual void preSimulationUpdate(float elapsedTime);
    virtual void simulationUpdate(float elapsedTime);
    virtual void postSimulationUpdate(float elapsedTime);
...
private:
    ...
    ProfilerController* _profilerController;
