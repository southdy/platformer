...
public:
     ...
     */
    void drawDebug(const Matrix& viewProjection, const Rectangle& viewport);
    ...
    Vector3 interpolate(Vector3 const & previous, Vector3 const & current) const;
...
private:
    ...
    float getPhysicsTimeAlpha() const;
    ...
    public:
        ...
        void begin(const Matrix& viewProjection, const Rectangle& viewport);
        void end();
