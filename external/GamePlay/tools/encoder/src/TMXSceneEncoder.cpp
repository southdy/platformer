...
void TMXSceneEncoder::parseBaseLayerProperties(const tinyxml2::XMLElement* xmlBaseLayer, tools::TMXBaseLayer* layer) const
{
...
void TMXSceneEncoder::writeSoloTileset(const TMXMap& map, const tools::TMXTileSet& tmxTileset, const TMXLayer& tileset, std::ofstream& file, unsigned int resultOnlyForTileset)
{
...
void TMXSceneEncoder::writeSprite(const tools::TMXImageLayer* imageLayer, std::ofstream& file)
{
    if (!imageLayer)
    {
        return;
